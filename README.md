## Forked to:
Add tests and examples of Hashtables of Hashtables of Hashtables to support slave_metas_ADDRESS.json schema for [AssimilateBus](https://github.com/IOT-123/AssimilateBus) new Netduino project for [ASSIMILATE IOT NETWORK](https://www.instructables.com/id/IOT123-ASSIMILATE-IOT-NETWORK/). These JSON files are used to build deviceJson JSON packets for [Crouton](http://crouton.mybluemix.net/crouton/gettingStarted) integration.
